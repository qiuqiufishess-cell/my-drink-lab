...
# --- 4. 页面设置 ---
st.set_page_config(page_title="秋秋的实验室 V5.0", layout="wide")
st.title("🍹 秋秋的云端饮品实验室")

# --- 5. 侧边栏：所有人均可上传 ---
with st.sidebar:
    st.header("📝 记录新灵感")
    st.info("💡 欢迎投稿！所有人都可以分享配方。")
    ...
    input_pwd = st.text_input("输入暗号解锁【修改/删除】", type="password")
    is_admin = (input_pwd == MY_PASSWORD)

# --- 6. 主展示区 ---
search_query = st.text_input("🔍 搜索配方...", placeholder="搜索你心仪的饮品")
st.markdown("---")
